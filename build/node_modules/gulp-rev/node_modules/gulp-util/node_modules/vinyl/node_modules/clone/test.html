<!doctype html><html><head><meta charset=utf-8><title>Clone Test-Suite (Browser)</title><script>
      var module = {};
    ...
    </script><script src=clone.js></script><script src=test.js></script></head><body><h1 id=nodeunit-header>Clone Test-Suite (Browser)</h1>Tests started: <span id=testsStarted></span>; Tests finished: <span id=testsFinished></span>.<ul id=logList></ul><script>
      /* Methods copied from
