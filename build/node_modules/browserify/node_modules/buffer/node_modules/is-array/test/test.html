<!DOCTYPE html><html><head><title>isArray Tests</title><meta http-equiv=Content-Type content="text/html; charset=UTF-8"><style>
      .fail {
        color: red;
      }
      .pass {
    ...
    </style></head><body><ul id=results></ul><script src=../build/build.js></script><script>
